      ...
      <div className="payment-container">
        <div className="payment-card summary">
          ...
          <div className="content">
            <ul>
              <li className="bold">
                Total <span>{(Number(price) + Number(protectionFee) + Number(deliveryFee)).toFixed(2)} €</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="payment-card">
          <div className="content">
            Il ne vous reste plus qu'une étape pour vous offrir <span className="bold">{title}</span>. Vous allez payer{" "}
            <span className="bold">{(Number(price) + Number(protectionFee) + Number(deliveryFee)).toFixed(2)} €</span>{" "}
